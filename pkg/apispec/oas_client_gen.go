...
type Invoker interface {
	...
	// APIV1SandboxesIDBandwidthGet invokes GET /api/v1/sandboxes/{id}/bandwidth operation.
	//
	// Get sandbox bandwidth policy.
	//
	// GET /api/v1/sandboxes/{id}/bandwidth
	APIV1SandboxesIDBandwidthGet(ctx context.Context, params APIV1SandboxesIDBandwidthGetParams, options ...RequestOption) (*SuccessBandwidthPolicyResponse, error)
	// APIV1SandboxesIDBandwidthPatch invokes PATCH /api/v1/sandboxes/{id}/bandwidth operation.
	//
	// Update sandbox bandwidth policy.
	//
	// PATCH /api/v1/sandboxes/{id}/bandwidth
	APIV1SandboxesIDBandwidthPatch(ctx context.Context, request *BandwidthPolicySpec, params APIV1SandboxesIDBandwidthPatchParams, options ...RequestOption) (*SuccessBandwidthPolicyResponse, error)
	...
	// APIV1SandboxesIDFilesBinaryGet invokes GET /api/v1/sandboxes/{id}/files/binary operation.
	//
	// Use query params:
	// - path=/tmp/a.txt: target file path.
	//
	// GET /api/v1/sandboxes/{id}/files/binary
	APIV1SandboxesIDFilesBinaryGet(ctx context.Context, params APIV1SandboxesIDFilesBinaryGetParams, options ...RequestOption) (*SuccessFileBinaryResponse, error)
	...
	APIV1SandboxesIDFilesGet(ctx context.Context, params APIV1SandboxesIDFilesGetParams, options ...RequestOption) (APIV1SandboxesIDFilesGetOK, error)
...
//
// GET /api/v1/sandboxes/{id}/bandwidth
func (c *Client) APIV1SandboxesIDBandwidthGet(ctx context.Context, params APIV1SandboxesIDBandwidthGetParams, options ...RequestOption) (*SuccessBandwidthPolicyResponse, error) {
	res, err := c.sendAPIV1SandboxesIDBandwidthGet(ctx, params, options...)
	return res, err
}

func (c *Client) sendAPIV1SandboxesIDBandwidthGet(ctx context.Context, params APIV1SandboxesIDBandwidthGetParams, requestOptions ...RequestOption) (res *SuccessBandwidthPolicyResponse, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, APIV1SandboxesIDBandwidthGetOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeAPIV1SandboxesIDBandwidthGetResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// PATCH /api/v1/sandboxes/{id}/bandwidth
func (c *Client) APIV1SandboxesIDBandwidthPatch(ctx context.Context, request *BandwidthPolicySpec, params APIV1SandboxesIDBandwidthPatchParams, options ...RequestOption) (*SuccessBandwidthPolicyResponse, error) {
	res, err := c.sendAPIV1SandboxesIDBandwidthPatch(ctx, request, params, options...)
	return res, err
}

func (c *Client) sendAPIV1SandboxesIDBandwidthPatch(ctx context.Context, request *BandwidthPolicySpec, params APIV1SandboxesIDBandwidthPatchParams, requestOptions ...RequestOption) (res *SuccessBandwidthPolicyResponse, err error) {
	...
	if err := encodeAPIV1SandboxesIDBandwidthPatchRequest(request, r); err != nil {
		return res, errors.Wrap(err, "encode request")
	}

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, APIV1SandboxesIDBandwidthPatchOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeAPIV1SandboxesIDBandwidthPatchResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// GET /api/v1/sandboxes/{id}/files/binary
func (c *Client) APIV1SandboxesIDFilesBinaryGet(ctx context.Context, params APIV1SandboxesIDFilesBinaryGetParams, options ...RequestOption) (*SuccessFileBinaryResponse, error) {
	res, err := c.sendAPIV1SandboxesIDFilesBinaryGet(ctx, params, options...)
	return res, err
}

func (c *Client) sendAPIV1SandboxesIDFilesBinaryGet(ctx context.Context, params APIV1SandboxesIDFilesBinaryGetParams, requestOptions ...RequestOption) (res *SuccessFileBinaryResponse, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, APIV1SandboxesIDFilesBinaryGetOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeAPIV1SandboxesIDFilesBinaryGetResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// GET /api/v1/sandboxes/{id}/files
func (c *Client) APIV1SandboxesIDFilesGet(ctx context.Context, params APIV1SandboxesIDFilesGetParams, options ...RequestOption) (APIV1SandboxesIDFilesGetOK, error) {
	res, err := c.sendAPIV1SandboxesIDFilesGet(ctx, params, options...)
	return res, err
}

func (c *Client) sendAPIV1SandboxesIDFilesGet(ctx context.Context, params APIV1SandboxesIDFilesGetParams, requestOptions ...RequestOption) (res APIV1SandboxesIDFilesGetOK, err error) {
