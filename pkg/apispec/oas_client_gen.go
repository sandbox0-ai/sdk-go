...
type Invoker interface {
	...
	// APIV1ObservabilityLogsGet invokes GET /api/v1/observability/logs operation.
	//
	// Returns OpenTelemetry log records stored for the selected team and region.
	//
	// GET /api/v1/observability/logs
	APIV1ObservabilityLogsGet(ctx context.Context, params APIV1ObservabilityLogsGetParams, options ...RequestOption) (APIV1ObservabilityLogsGetRes, error)
	// APIV1ObservabilityTracesGet invokes GET /api/v1/observability/traces operation.
	//
	// Returns OpenTelemetry trace spans stored for the selected team and region.
	//
	// GET /api/v1/observability/traces
	APIV1ObservabilityTracesGet(ctx context.Context, params APIV1ObservabilityTracesGetParams, options ...RequestOption) (APIV1ObservabilityTracesGetRes, error)
...
//
// GET /api/v1/observability/logs
func (c *Client) APIV1ObservabilityLogsGet(ctx context.Context, params APIV1ObservabilityLogsGetParams, options ...RequestOption) (APIV1ObservabilityLogsGetRes, error) {
	res, err := c.sendAPIV1ObservabilityLogsGet(ctx, params, options...)
	return res, err
}

func (c *Client) sendAPIV1ObservabilityLogsGet(ctx context.Context, params APIV1ObservabilityLogsGetParams, requestOptions ...RequestOption) (res APIV1ObservabilityLogsGetRes, err error) {
	...
	u = uri.Clone(u)
	var pathParts [1]string
	pathParts[0] = "/api/v1/observability/logs"
	uri.AddPathParts(u, pathParts[:]...)

	q := uri.NewQueryEncoder()
	{
		// Encode "sandbox_id" parameter.
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, APIV1ObservabilityLogsGetOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeAPIV1ObservabilityLogsGetResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
...
//
// GET /api/v1/observability/traces
func (c *Client) APIV1ObservabilityTracesGet(ctx context.Context, params APIV1ObservabilityTracesGetParams, options ...RequestOption) (APIV1ObservabilityTracesGetRes, error) {
	res, err := c.sendAPIV1ObservabilityTracesGet(ctx, params, options...)
	return res, err
}

func (c *Client) sendAPIV1ObservabilityTracesGet(ctx context.Context, params APIV1ObservabilityTracesGetParams, requestOptions ...RequestOption) (res APIV1ObservabilityTracesGetRes, err error) {
	...
	u = uri.Clone(u)
	var pathParts [1]string
	pathParts[0] = "/api/v1/observability/traces"
	uri.AddPathParts(u, pathParts[:]...)
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, APIV1ObservabilityTracesGetOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeAPIV1ObservabilityTracesGetResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
