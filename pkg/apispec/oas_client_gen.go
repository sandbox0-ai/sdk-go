...
type Invoker interface {
	...
	// APIV1SandboxesIDFunctionsNameInvokePost invokes POST /api/v1/sandboxes/{id}/functions/{name}/invoke operation.
	//
	// Invokes /workspace/functions/{name}.py through the Python function runtime. The default handler is
	// `handler`.
	//
	// POST /api/v1/sandboxes/{id}/functions/{name}/invoke
	APIV1SandboxesIDFunctionsNameInvokePost(ctx context.Context, request *FunctionInvokeRequest, params APIV1SandboxesIDFunctionsNameInvokePostParams, options ...RequestOption) (APIV1SandboxesIDFunctionsNameInvokePostRes, error)
...
//
// POST /api/v1/sandboxes/{id}/functions/{name}/invoke
func (c *Client) APIV1SandboxesIDFunctionsNameInvokePost(ctx context.Context, request *FunctionInvokeRequest, params APIV1SandboxesIDFunctionsNameInvokePostParams, options ...RequestOption) (APIV1SandboxesIDFunctionsNameInvokePostRes, error) {
	res, err := c.sendAPIV1SandboxesIDFunctionsNameInvokePost(ctx, request, params, options...)
	return res, err
}

func (c *Client) sendAPIV1SandboxesIDFunctionsNameInvokePost(ctx context.Context, request *FunctionInvokeRequest, params APIV1SandboxesIDFunctionsNameInvokePostParams, requestOptions ...RequestOption) (res APIV1SandboxesIDFunctionsNameInvokePostRes, err error) {
	...
	if err := encodeAPIV1SandboxesIDFunctionsNameInvokePostRequest(request, r); err != nil {
		return res, errors.Wrap(err, "encode request")
	}

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, APIV1SandboxesIDFunctionsNameInvokePostOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeAPIV1SandboxesIDFunctionsNameInvokePostResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
