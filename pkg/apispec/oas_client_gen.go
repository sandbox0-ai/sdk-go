...
type Invoker interface {
	...
	// APIV1SandboxvolumesIDFilesClonePost invokes POST /api/v1/sandboxvolumes/{id}/files/clone operation.
	//
	...
	//
	// POST /api/v1/sandboxvolumes/{id}/files/clone
	APIV1SandboxvolumesIDFilesClonePost(ctx context.Context, request *CloneVolumeFilesRequest, params APIV1SandboxvolumesIDFilesClonePostParams, options ...RequestOption) (APIV1SandboxvolumesIDFilesClonePostRes, error)
...
//
// POST /api/v1/sandboxvolumes/{id}/files/clone
func (c *Client) APIV1SandboxvolumesIDFilesClonePost(ctx context.Context, request *CloneVolumeFilesRequest, params APIV1SandboxvolumesIDFilesClonePostParams, options ...RequestOption) (APIV1SandboxvolumesIDFilesClonePostRes, error) {
	res, err := c.sendAPIV1SandboxvolumesIDFilesClonePost(ctx, request, params, options...)
	return res, err
}

func (c *Client) sendAPIV1SandboxvolumesIDFilesClonePost(ctx context.Context, request *CloneVolumeFilesRequest, params APIV1SandboxvolumesIDFilesClonePostParams, requestOptions ...RequestOption) (res APIV1SandboxvolumesIDFilesClonePostRes, err error) {
	...
	if err := encodeAPIV1SandboxvolumesIDFilesClonePostRequest(request, r); err != nil {
		return res, errors.Wrap(err, "encode request")
	}

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, APIV1SandboxvolumesIDFilesClonePostOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
	...
	result, err := decodeAPIV1SandboxvolumesIDFilesClonePostResponse(resp)
	if err != nil {
		return res, errors.Wrap(err, "decode response")
	}
