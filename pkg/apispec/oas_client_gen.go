...
type Invoker interface {
	...
	AuthRegionTokenPost(ctx context.Context, request *IssueRegionTokenRequest, options ...RequestOption) (AuthRegionTokenPostRes, error)
...
//
// POST /auth/region-token
func (c *Client) AuthRegionTokenPost(ctx context.Context, request *IssueRegionTokenRequest, options ...RequestOption) (AuthRegionTokenPostRes, error) {
	res, err := c.sendAuthRegionTokenPost(ctx, request, options...)
	return res, err
}

func (c *Client) sendAuthRegionTokenPost(ctx context.Context, request *IssueRegionTokenRequest, requestOptions ...RequestOption) (res AuthRegionTokenPostRes, err error) {
