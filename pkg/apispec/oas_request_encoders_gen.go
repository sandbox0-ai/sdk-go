...
func encodeAPIV1SandboxfilesystemsIDForkPostRequest(
	req OptForkSandboxFilesystemRequest,
	r *http.Request,
) error {
	const contentType = "application/json"
	if !req.Set {
...
func encodeAPIV1SandboxfilesystemsIDSnapshotsPostRequest(
	req *CreateSandboxFilesystemSnapshotRequest,
	r *http.Request,
) error {
	const contentType = "application/json"
	e := new(jx.Encoder)
...
func encodeAPIV1SandboxfilesystemsPostRequest(
	req *CreateSandboxFilesystemRequest,
	r *http.Request,
) error {
	const contentType = "application/json"
	e := new(jx.Encoder)
