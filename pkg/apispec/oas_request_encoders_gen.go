...
func encodeAPIV1SandboxvolumesIDSyncBootstrapPostRequest(
	req OptCreateVolumeSyncBootstrapRequest,
	r *http.Request,
) error {
	const contentType = "application/json"
	if !req.Set {
...
func encodeAPIV1SandboxvolumesIDSyncConflictsConflictIDPutRequest(
	req *ResolveVolumeSyncConflictRequest,
	r *http.Request,
) error {
	const contentType = "application/json"
	e := new(jx.Encoder)
...
func encodeAPIV1SandboxvolumesIDSyncReplicasReplicaIDChangesPostRequest(
	req *AppendReplicaChangesRequest,
	r *http.Request,
) error {
	const contentType = "application/json"
	e := new(jx.Encoder)
...
func encodeAPIV1SandboxvolumesIDSyncReplicasReplicaIDCursorPutRequest(
	req *UpdateSyncReplicaCursorRequest,
	r *http.Request,
) error {
	const contentType = "application/json"
	e := new(jx.Encoder)
...
func encodeAPIV1SandboxvolumesIDSyncReplicasReplicaIDPutRequest(
	req *UpsertSyncReplicaRequest,
	r *http.Request,
) error {
	const contentType = "application/json"
	e := new(jx.Encoder)
